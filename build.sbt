...
compilec := """g++ output/java_lang.cpp output/output.cpp -o output/a.out """.!
...
val getcp = TaskKey[Unit]("getcp", "get classpath")
getcp <<= (target, fullClasspath in Runtime) map { (target, cp) =>
