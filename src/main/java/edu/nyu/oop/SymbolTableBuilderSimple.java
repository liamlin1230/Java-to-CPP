...
/*
 * A simple and incomplete SymbolTable populator
 * that demonstrates how the scopes within the symbol table are built.
 */
public class SymbolTableBuilderSimple extends Visitor {
    final private SymbolTable table;
    final private Runtime runtime;

    public SymbolTableBuilderSimple(final Runtime runtime, final SymbolTable table) {
